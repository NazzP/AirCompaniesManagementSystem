...
-- Inserting Flights
INSERT INTO flights (flight_status, airplane_id, aircompany_id, departure_country, destination_country, distance, estimated_flight_time, started_at, ended_at, delay_started_at, created_at) VALUES ('ACTIVE', 1, 1, 'Country1', 'Country2', 2500.0, 2.5, '2025-01-01 12:00:00', NULL , NULL, '2025-01-01 11:30:00');
...
INSERT INTO flights (flight_status, airplane_id, aircompany_id, departure_country, destination_country, distance, estimated_flight_time, started_at, ended_at, delay_started_at, created_at) VALUES ('DELAYED', 3, 3, 'Country3', 'Country4', 7500.0, 7.5, '2025-01-03 12:30:00', NULL , '2025-01-03 12:45:00', '2025-01-03 12:15:00');
